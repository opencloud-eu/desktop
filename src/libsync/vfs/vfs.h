 ...
 * function.
 */
class OPENCLOUD_SYNC_EXPORT Vfs : public QObject
{
    Q_OBJECT
...
class OPENCLOUD_SYNC_EXPORT VfsPluginManager
{
public:
...
template <>
OPENCLOUD_SYNC_EXPORT QString Utility::enumToString(Vfs::Mode mode);
