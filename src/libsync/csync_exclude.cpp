 ...
 */
OPENCLOUD_SYNC_EXPORT void csync_exclude_expand_escapes(QByteArray &input)
{
    qsizetype o = 0;
 ...
 */
OPENCLOUD_SYNC_EXPORT bool csync_is_windows_reserved_word(QStringView filename)
{
