...
uint64_t GETFileJob::contentLength() const
{
    return _contentLength.value_or(0);
}

uint64_t GETFileJob::expectedContentLength() const
{
    return _expectedContentLength.value_or(0);
}
