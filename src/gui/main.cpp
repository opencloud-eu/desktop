...
int main(int argc, char **argv)
{
    return RestartManager([](int argc, char **argv) {
        ...
        const QString originalDesktopFileName = app.desktopFileName();
#ifdef Q_OS_LINUX
        // HACK:
        ...
        // As we preferably use AppImages the real deskop file name is unknown. We just ensure it matches the StartupWMClass entry in our desktop file
        ...
        ocApp->setDesktopFileName(originalDesktopFileName);
