...
QString Utility::socketApiSocketPath()
{
    ...
    // Example for developer builds (with ad-hoc signing identity): "" "eu.opencloud.OpenCloudDesktop" ".socketApi"
    // Example for official signed packages: "9B5WD74GWJ." "eu.opencloud.OpenCloudDesktop" ".socketApi"
