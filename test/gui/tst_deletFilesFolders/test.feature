Feature: deleting files and folders
    ...
    Scenario: Delete multiple files
        ...
        And user "Alice" has uploaded file with content "openCloud test text file" to "textfile1.txt" in the server
        And user "Alice" has uploaded file with content "openCloud test text file" to "textfile2.txt" in the server
        And user "Alice" has set up a client with default settings
